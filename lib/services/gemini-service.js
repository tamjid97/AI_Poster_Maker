...
exports.getDefaultLayoutSuggestion = exports.getLayoutSuggestion = void 0;
const generative_ai_1 = require("@google/generative-ai");
const geminiApiKey = process.env.GEMINI_API_KEY || '';
async function getLayoutSuggestion(params) {
    if (!geminiApiKey) {
...
exports.getLayoutSuggestion = getLayoutSuggestion;
function getDefaultLayoutSuggestion(params) {
    ...
    if (config) {
        return {
            ...
            colorPalette: {
                ...
                background: config.bgStyle === 'gradient' ? config.bgFrom || config.primaryColor : config.bgColor || '#1a1a1a',
...
exports.getDefaultLayoutSuggestion = getDefaultLayoutSuggestion;
